        ...
        if (args[0].toLowerCase() === "start") {
            try{
                ...
                let options = {
                    ...
                    bonusEntries: [],
                    messages: {
                        inviteToParticipate: "***React with <a:Tada_Yellow:1269513176387420161> to participate!***\n",
                        drawing: "> Ends: {timestamp}\n",
                        hostedBy: "**Hosted by:** {this.hostedBy}",
                        dropMessage: "Be the first to react with <a:Tada_Yellow:1269513176387420161>",
                        noWinner: "\n**Giveaway cancelled!**\n> No valid participations. :cry:",
                        endedAt: "Ends at", 
                        giveaway: '<a:Tada_Yellow:1269513176387420161> **GIVEAWAY STARTED** <a:Tada_Yellow:1269513176387420161>',
                        giveawayEnded: '<a:Tada_Green:1269513125409980416> **GIVEAWAY ENDED** <a:Tada_Green:1269513125409980416>',
            ...
            client.giveawaysManager.reroll(giveaway.messageId, { winnerCount: !isNaN(args[1]) ? Number(args[1]) : 1})
                ...
                .catch((e) => {
                    if (e.startsWith(`Giveaway with message Id ${giveaway.messageId} is not ended.`)) {
                        ...
                        console.error(e);
                        message.reply({content : '<:no:1269533999014084683> **An error occured...**```' + String(e.message).substring(0, 1900) + "```"});
                    }
                });
            ...
            client.giveawaysManager.edit(messageId, {
                ...
                const numyener5855fSecondsMax = client.giveawaysManager.options.updateCountdownEvery / 1000;
