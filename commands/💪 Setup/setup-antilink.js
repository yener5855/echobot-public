        ...
        let menuoptions = [
          {
            ...
            emoji: `${client.settings.get(message.guild.id, `antilink.enabled`) ? "1269533966009106465" : "1269542548771180618"}`
          },
          {
            value: "Settings",
