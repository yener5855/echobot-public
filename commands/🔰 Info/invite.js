...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if(user) {
        if(!user.bot) return interaction?.reply({ephemeral: true, content: "<:no:1269533966009106465> You can't Invite a Normal user! **IT MUST BE A BOT**"})
        ...
        message.reply({ 
          embeds: [new MessageEmbed()
            ...
            .setFooter(client.getFooter(`${user.username} | powered by https://yener5855.is-local.org/`, "https://imgur.com/jPItIw0.gif"))],
